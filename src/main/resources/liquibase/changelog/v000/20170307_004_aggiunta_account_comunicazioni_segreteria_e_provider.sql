...
VALUES (nextval('hibernate_sequence'), FALSE, null, 'ECM', null, 'segreteria@ecm.it', TRUE, null, FALSE, 'Segreteria', null, '$2a$10$JCx8DPs0l0VNFotVGkfW/uRyJzFfc8HkTi5FQy0kpHSpq7W4iP69.', 'segreteriacomunicazioni', 'segreteriacomunicazioni', 0, null, TRUE);

-- account fake per comunicazioni provider
INSERT INTO account (id, change_password, codice_fiscale, cognome, data_scadenza_password, email, enabled, expires_date, locked, nome, note, password, username, username_workflow, valutazioni_non_date, provider_id, fake_account_comunicazioni)
SELECT nextval('hibernate_sequence'), FALSE, null, 'Provider', null, CONCAT('provider', id, '@comunicazioni.it'), TRUE, null, FALSE, 'Comunicazioni', null, '$2a$10$JCx8DPs0l0VNFotVGkfW/uRyJzFfc8HkTi5FQy0kpHSpq7W4iP69.', CONCAT('provider', id, 'comunicazioni'), CONCAT('provider', id, 'comunicazioni'), 0, id, TRUE
FROM provider;
