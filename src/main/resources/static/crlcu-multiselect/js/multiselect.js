        ...
        **/
        function Multiselect( $select, settings ) {
            ...
            this.actions = {
                ...
                $rightAllOpt:	$( settings.rightAllOpt ).lenght ? $( settings.rightAllOpt ) : $('#' + id + '_rightAllOpt'),
                $leftAllOpt:	$( settings.leftAllOpt ).lenght ? $( settings.leftAllOpt ) : $('#' + id + '_leftAllOpt'),
...
//                    });
                    ...
                    $options.each(function(index, option) {
                        ...
                        if ($option.is('optgroup') || $option.parent().is('optgroup')) {
                            var $leftGroup = $option.is('optgroup') ? $option : $option.parent();
                            var $rightGroup = self.$right.find('optgroup[label="' + $leftGroup.prop('label') + '"]');
                            ...
                            $option = $rightGroup.append($option.is('optgroup') ? $option.children() : $option );
