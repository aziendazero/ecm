...
public enum TipologiaEventoFSCEnum {
	...
	PROGETTI_DI_MIGLIORAMENTO(3,"Progetti di miglioramento",Arrays.asList(RuoloFSCEnum.PARTECIPANTE,RuoloFSCEnum.ESPERTO,RuoloFSCEnum.COORDINATORE_GRUPPI)), //sstagni - tolto in quando non gestito dal cogeaps
