...
public enum IdFieldEnum {
	...
	LEGALE_RAPPRESENTANTE__COGNOME ("persona.anagrafica.cognome",22,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "cognome"),
	LEGALE_RAPPRESENTANTE__NOME ("persona.anagrafica.nome",23,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "nome"),
	...
	RESPONSABILE_QUALITA__COGNOME ("persona.anagrafica.cognome", 81, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.RESPONSABILE_QUALITA),
	RESPONSABILE_QUALITA__NOME ("persona.anagrafica.nome", 82, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.RESPONSABILE_QUALITA),
	RESPONSABILE_QUALITA__CODICEFISCALE ("persona.anagrafica.codiceFiscale", 83, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.RESPONSABILE_QUALITA),
	RESPONSABILE_QUALITA__TELEFONO ("persona.anagrafica.telefono", 84, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.RESPONSABILE_QUALITA),
	RESPONSABILE_QUALITA__EMAIL ("persona.anagrafica.email", 85, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.RESPONSABILE_QUALITA),
