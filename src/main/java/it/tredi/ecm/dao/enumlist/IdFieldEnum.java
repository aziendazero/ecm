...
public enum IdFieldEnum {
	...
	COMPONENTE_COMITATO_SCIENTIFICO__IS_COORDINATORE("persona.coordinatore", -1, Ruolo.COMPONENTE_COMITATO_SCIENTIFICO, SubSetFieldEnum.COMPONENTE_COMITATO_SCIENTIFICO, "coordinatoreComitatoScientifico"),
	...
	ACCREDITAMENTO_ALLEGATI__RICHIESTA_ACCREDITAMENTO_STANDARD ("richiestaAccreditamentoStandard", 87, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO, "files.FILE_RICHIESTA_ACCREDITAMENTO_STANDARD"),
	ACCREDITAMENTO_ALLEGATI__RELAZIONE_ATTIVITA_FORMATIVA ("relazioneAttivitaFormativa", 88, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO, "files.FILE_RELAZIONE_ATTIVITA_FORMATIVA"),

	VALUTAZIONE_SUL_CAMPO__PIANO_FORMATIVO("pianoFormativo", 89, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "pianoFormativo"),
	VALUTAZIONE_SUL_CAMPO__IDONEITA_SEDE("idoneitaSede", 90, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "idoneitaSede"),
	VALUTAZIONE_SUL_CAMPO__RELAZIONE_ANNUALE("relazioneAnnuale", 91, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "relazioneAnnuale"),
	VALUTAZIONE_SUL_CAMPO__PERCEZIONE_INTERESSE_COMMERICALE_SANITA("percezioneInteresseCommercialeQualita", 92, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "percezioneInteresseCommercialeQualita"),
	VALUTAZIONE_SUL_CAMPO__SCHEDA_QUALITA_PERCEPITA("schedaQualitaPercepita", 93, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "schedaQualitaPercepita"),
	VALUTAZIONE_SUL_CAMPO__PRESENZA_PARTECIPANTI("presenzaPartecipanti", 94, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "presenzaPartecipanti"),
	VALUTAZIONE_SUL_CAMPO__RECLUTAMENTO_DIRETTO("reclutamentoDiretto", 95, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "reclutamentoDiretto"),
	VALUTAZIONE_SUL_CAMPO__VERIFICA_APPRENDIMENTO("verificaApprendimento", 96, null, SubSetFieldEnum.VALUTAZIONE_SUL_CAMPO, "verificaApprendimento"),
