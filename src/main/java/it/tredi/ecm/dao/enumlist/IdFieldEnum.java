...
public enum IdFieldEnum {
	...
	SEDE_LEGALE__FULL ("SedeLegale", -1, null, SubSetFieldEnum.FULL),
	SEDE_OPERATIVA__FULL ("SedeOperativa", -1, null, SubSetFieldEnum.FULL),
	LEGALE_RAPPRESENTANTE__FULL ("persona.legaleRappresentante",-1,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.FULL),
	DELEGATO_LEGALE_RAPPRESENTANTE__FULL ("persona.delegatoLegaleRappresentante",-1,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.FULL),
	RESPONSABILE_SEGRETERIA__FULL ("persona.anagrafica", -1, Ruolo.RESPONSABILE_SEGRETERIA, SubSetFieldEnum.FULL),
	RESPONSABILE_AMMINISTRATIVO__FULL ("persona.anagrafica", -1, Ruolo.RESPONSABILE_AMMINISTRATIVO, SubSetFieldEnum.FULL),
	RESPONSABILE_SISTEMA_INFORMATICO__FULL ("persona.anagrafica", -1, Ruolo.RESPONSABILE_SISTEMA_INFORMATICO, SubSetFieldEnum.FULL),
	RESPONSABILE_QUALITA__FULL ("persona.anagrafica", -1, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.FULL),
