...
public enum IdFieldEnum {
	...
	PROVIDER__NATURA_ORGANIZZAZIONE ("provider.naturaOrganizzazione", 6, null, SubSetFieldEnum.PROVIDER, "naturaOrganizzazione"),
	...
	SEDE_LEGALE__PROVINCIA ("sede.provincia", 8, null, SubSetFieldEnum.SEDE_LEGALE, "provincia"),
	SEDE_LEGALE__COMUNE ("sede.comune", 9, null, SubSetFieldEnum.SEDE_LEGALE, "comune"),
	SEDE_LEGALE__INDIRIZZO ("sede.indirizzo", 10, null, SubSetFieldEnum.SEDE_LEGALE, "indirizzo"),
	SEDE_LEGALE__CAP ("sede.cap", 11, null, SubSetFieldEnum.SEDE_LEGALE, "cap"),
	SEDE_LEGALE__TELEFONO ("sede.telefono", 12, null, SubSetFieldEnum.SEDE_LEGALE, "telefono"),
	SEDE_LEGALE__FAX ("sede.fax", 13, null, SubSetFieldEnum.SEDE_LEGALE, "fax"),
	SEDE_LEGALE__EMAIL ("sede.email", 14, null, SubSetFieldEnum.SEDE_LEGALE, "email"),

	SEDE_OPERATIVA__FULL ("sede", -1, null, SubSetFieldEnum.SEDE_OPERATIVA),
	SEDE_OPERATIVA__PROVINCIA ("sede.provincia", 15, null, SubSetFieldEnum.SEDE_OPERATIVA, "provincia"),
	SEDE_OPERATIVA__COMUNE ("sede.comune", 16, null, SubSetFieldEnum.SEDE_OPERATIVA, "comune"),
	SEDE_OPERATIVA__INDIRIZZO ("sede.indirizzo", 17, null, SubSetFieldEnum.SEDE_OPERATIVA, "indirizzo"),
	SEDE_OPERATIVA__CAP ("sede.cap", 18, null, SubSetFieldEnum.SEDE_OPERATIVA, "cap"),
	SEDE_OPERATIVA__TELEFONO ("sede.telefono", 19, null, SubSetFieldEnum.SEDE_OPERATIVA, "telefono"),
	SEDE_OPERATIVA__FAX ("sede.fax", 20, null, SubSetFieldEnum.SEDE_OPERATIVA, "fax"),
	SEDE_OPERATIVA__EMAIL ("sede.email", 21, null, SubSetFieldEnum.SEDE_OPERATIVA, "email"),
	...
	LEGALE_RAPPRESENTANTE__COGNOME ("persona.anagrafica.cognome",22,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "anagrafica.cognome"),
	LEGALE_RAPPRESENTANTE__NOME ("persona.anagrafica.nome",23,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "anagrafica.nome"),
	LEGALE_RAPPRESENTANTE__CODICEFISCALE ("persona.anagrafica.codiceFiscale",24,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "anagrafica.codiceFiscale"),
	LEGALE_RAPPRESENTANTE__TELEFONO ("persona.anagrafica.telefono",25,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "anagrafica.telefono"),
	LEGALE_RAPPRESENTANTE__CELLULARE ("persona.anagrafica.cellulare",26,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "anagrafica.cellulare"),
	LEGALE_RAPPRESENTANTE__EMAIL ("persona.anagrafica.email",27,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "anagrafica.email"),
	LEGALE_RAPPRESENTANTE__PEC ("persona.anagrafica.pec",28,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "anagrafica.pec"),
	LEGALE_RAPPRESENTANTE__ATTO_NOMINA ("attoNomina",29,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "files.FILE_ATTO_NOMINA"),
	LEGALE_RAPPRESENTANTE__CV ("cv",30,Ruolo.LEGALE_RAPPRESENTANTE, SubSetFieldEnum.LEGALE_RAPPRESENTANTE, "files.FILE_CV"),
	...
	DELEGATO_LEGALE_RAPPRESENTANTE__COGNOME ("persona.anagrafica.cognome",31,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.DELEGATO_LEGALE_RAPPRESENTANTE, "anagrafica.cognome"),
	DELEGATO_LEGALE_RAPPRESENTANTE__NOME ("persona.anagrafica.nome",32,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.DELEGATO_LEGALE_RAPPRESENTANTE, "anagrafica.nome"),
	DELEGATO_LEGALE_RAPPRESENTANTE__CODICEFISCALE ("persona.anagrafica.codiceFiscale",33,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.DELEGATO_LEGALE_RAPPRESENTANTE, "anagrafica.codiceFiscale"),
	DELEGATO_LEGALE_RAPPRESENTANTE__TELEFONO ("persona.anagrafica.telefono",34,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.DELEGATO_LEGALE_RAPPRESENTANTE, "anagrafica.telefono"),
	DELEGATO_LEGALE_RAPPRESENTANTE__CELLULARE ("persona.anagrafica.cellulare",35,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.DELEGATO_LEGALE_RAPPRESENTANTE, "anagrafica.cellulare"),
	DELEGATO_LEGALE_RAPPRESENTANTE__EMAIL ("persona.anagrafica.email",36,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.DELEGATO_LEGALE_RAPPRESENTANTE, "anagrafica.email"),
	DELEGATO_LEGALE_RAPPRESENTANTE__CV ("cv",37,Ruolo.DELEGATO_LEGALE_RAPPRESENTANTE, SubSetFieldEnum.DELEGATO_LEGALE_RAPPRESENTANTE, "files.FILE_CV"),
	...
	DATI_ACCREDITAMENTO__TIPOLOGIA_ACCREDITAMENTO ("datiAccreditamento.tipologiaAccreditamento", 39, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "tipologiaAccreditamento"),
	...
	DATI_ACCREDITAMENTO__PROFESSIONI_ACCREDITAMENTO ("datiAccreditamento.professioniAccreditamento", 41, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "professioniAccreditamento"),
	DATI_ACCREDITAMENTO__DISCIPLINE ("datiAccreditamento.discipline", 42, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "discipline"),
	DATI_ACCREDITAMENTO__FATTURATO_COMPLESSIVO ("datiAccreditamento.datiEconomici.fatturatoComplessivo", 43, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "fatturatoComplessivo"),
	DATI_ACCREDITAMENTO__ESTRATTO_BILANCIO_COMPLESSIVO ("datiAccreditamento.estrattoBilancioComplessivo", 44, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "files.FILE_ESTRATTO_BILANCIO_COMPLESSIVO"),
	DATI_ACCREDITAMENTO__FATTURATO_FORMAZIONE ("datiAccreditamento.datiEconomici.fatturatoFormazione", 45, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "fatturatoFormazione"),
	DATI_ACCREDITAMENTO__ESTRATTO_BILANCIO_FORMAZIONE ("datiAccreditamento.estrattoBilancioFormazione", 46, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "files.FILE_ESTRATTO_BILANCIO_FORMAZIONE"),
	...
	DATI_ACCREDITAMENTO__ORGANIGRAMMA ("datiAccreditamento.organigramma", 48, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "files.FILE_ORGANIGRAMMA"),
	DATI_ACCREDITAMENTO__FUNZIONIGRAMMA ("datiAccreditamento.funzionigramma", 49, null, SubSetFieldEnum.DATI_ACCREDITAMENTO, "files.FILE_FUNZIONIGRAMMA"),
	...
	RESPONSABILE_SEGRETERIA__TELEFONO ("persona.anagrafica.telefono",53,Ruolo.RESPONSABILE_SEGRETERIA, SubSetFieldEnum.RESPONSABILE_SEGRETERIA, "anagrafica.telefono"),
	RESPONSABILE_SEGRETERIA__EMAIL ("persona.anagrafica.email",54,Ruolo.RESPONSABILE_SEGRETERIA, SubSetFieldEnum.RESPONSABILE_SEGRETERIA, "anagrafica.email"),
	RESPONSABILE_SEGRETERIA__ATTO_NOMINA ("attoNomina",55,Ruolo.RESPONSABILE_SEGRETERIA, SubSetFieldEnum.RESPONSABILE_SEGRETERIA, "files.FILE_ATTO_NOMINA"),
	RESPONSABILE_SEGRETERIA__CV ("cv",56,Ruolo.RESPONSABILE_SEGRETERIA, SubSetFieldEnum.RESPONSABILE_SEGRETERIA, "files.FILE_CV"),
	...
	RESPONSABILE_AMMINISTRATIVO__COGNOME ("persona.anagrafica.cognome", 57, Ruolo.RESPONSABILE_AMMINISTRATIVO, SubSetFieldEnum.RESPONSABILE_AMMINISTRATIVO, "anagrafica.cognome"),
	RESPONSABILE_AMMINISTRATIVO__NOME ("persona.anagrafica.nome", 58, Ruolo.RESPONSABILE_AMMINISTRATIVO, SubSetFieldEnum.RESPONSABILE_AMMINISTRATIVO, "anagrafica.nome"),
	RESPONSABILE_AMMINISTRATIVO__CODICEFISCALE ("persona.anagrafica.codiceFiscale", 59, Ruolo.RESPONSABILE_AMMINISTRATIVO, SubSetFieldEnum.RESPONSABILE_AMMINISTRATIVO, "anagrafica.codiceFiscale"),
	RESPONSABILE_AMMINISTRATIVO__TELEFONO ("persona.anagrafica.telefono", 60, Ruolo.RESPONSABILE_AMMINISTRATIVO, SubSetFieldEnum.RESPONSABILE_AMMINISTRATIVO, "anagrafica.telefono"),
	RESPONSABILE_AMMINISTRATIVO__CELLULARE ("persona.anagrafica.cellulare", 61, Ruolo.RESPONSABILE_AMMINISTRATIVO, SubSetFieldEnum.RESPONSABILE_AMMINISTRATIVO, "anagrafica.cellulare"),
	...
	COMPONENTE_COMITATO_SCIENTIFICO__CELLULARE ("persona.anagrafica.cellulare", 69, Ruolo.COMPONENTE_COMITATO_SCIENTIFICO, SubSetFieldEnum.COMPONENTE_COMITATO_SCIENTIFICO, "anagrafica.cellulare"),
