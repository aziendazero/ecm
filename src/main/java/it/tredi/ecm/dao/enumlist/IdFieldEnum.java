...
public enum IdFieldEnum {
	...
	SEDE_LEGALE__PROVINCIA ("SedeLegale.provincia", 8, null, SubSetFieldEnum.SEDE_LEGALE, "provincia"),
	SEDE_LEGALE__COMUNE ("SedeLegale.comune", 9, null, SubSetFieldEnum.SEDE_LEGALE, "comune"),
	SEDE_LEGALE__INDIRIZZO ("SedeLegale.indirizzo", 10, null, SubSetFieldEnum.SEDE_LEGALE, "indirizzo"),
	SEDE_LEGALE__CAP ("SedeLegale.cap", 11, null, SubSetFieldEnum.SEDE_LEGALE, "cap"),
	SEDE_LEGALE__TELEFONO ("SedeLegale.telefono", 12, null, SubSetFieldEnum.SEDE_LEGALE, "telefono"),
	SEDE_LEGALE__FAX ("SedeLegale.fax", 13, null, SubSetFieldEnum.SEDE_LEGALE, "fax"),
	SEDE_LEGALE__EMAIL ("SedeLegale.email", 14, null, SubSetFieldEnum.SEDE_LEGALE, "email"),

	SEDE_OPERATIVA__FULL ("SedeOperativa", -1, null, SubSetFieldEnum.SEDE_OPERATIVA),
	SEDE_OPERATIVA__PROVINCIA ("SedeOperativa.provincia", 15, null, SubSetFieldEnum.SEDE_OPERATIVA, "provincia"),
	SEDE_OPERATIVA__COMUNE ("SedeOperativa.comune", 16, null, SubSetFieldEnum.SEDE_OPERATIVA, "comune"),
	SEDE_OPERATIVA__INDIRIZZO ("SedeOperativa.indirizzo", 17, null, SubSetFieldEnum.SEDE_OPERATIVA, "indirizzo"),
	SEDE_OPERATIVA__CAP ("SedeOperativa.cap", 18, null, SubSetFieldEnum.SEDE_OPERATIVA, "cap"),
	SEDE_OPERATIVA__TELEFONO ("SedeOperativa.telefono", 19, null, SubSetFieldEnum.SEDE_OPERATIVA, "telefono"),
	SEDE_OPERATIVA__FAX ("SedeOperativa.fax", 20, null, SubSetFieldEnum.SEDE_OPERATIVA, "fax"),
	SEDE_OPERATIVA__EMAIL ("SedeOperativa.email", 21, null, SubSetFieldEnum.SEDE_OPERATIVA, "email"),
	...
	RESPONSABILE_SEGRETERIA__ATTO_NOMINA ("persona.file.attoNomina",55,Ruolo.RESPONSABILE_SEGRETERIA, SubSetFieldEnum.RESPONSABILE_SEGRETERIA, "files.FILE_ATTO_NOMINA"),
	RESPONSABILE_SEGRETERIA__CV ("persona.file.cv",56,Ruolo.RESPONSABILE_SEGRETERIA, SubSetFieldEnum.RESPONSABILE_SEGRETERIA, "files.FILE_CV"),
	...
	RESPONSABILE_SISTEMA_INFORMATICO__ATTO_NOMINA ("persona.file.attoNomina", 79, Ruolo.RESPONSABILE_SISTEMA_INFORMATICO, SubSetFieldEnum.RESPONSABILE_SISTEMA_INFORMATICO),
	RESPONSABILE_SISTEMA_INFORMATICO__CV ("persona.file.cv", 80, Ruolo.RESPONSABILE_SISTEMA_INFORMATICO, SubSetFieldEnum.RESPONSABILE_SISTEMA_INFORMATICO),
	...
	RESPONSABILE_QUALITA__ATTO_NOMINA ("persona.file.attoNomina", 86, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.RESPONSABILE_QUALITA),
	RESPONSABILE_QUALITA__CV ("persona.file.cv", 87, Ruolo.RESPONSABILE_QUALITA, SubSetFieldEnum.RESPONSABILE_QUALITA),
	...
	ACCREDITAMENTO_ALLEGATI__ATTO_COSTITUIVO ("accreditamentoAllegati.file.attoCostitutivo", 88, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO),
	ACCREDITAMENTO_ALLEGATI__ESPERIENZA_FORMAZIONE ("accreditamentoAllegati.file.esperienzaFormazione", 89, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO),
	ACCREDITAMENTO_ALLEGATI__UTILIZZO ("accreditamentoAllegati.file.utilizzo", 90, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO),
	ACCREDITAMENTO_ALLEGATI__SISTEMA_INFORMATICO ("accreditamentoAllegati.file.sistemaInformatico", 91, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO),
	ACCREDITAMENTO_ALLEGATI__PIANO_QUALITA ("accreditamentoAllegati.file.pianoQualita", 92, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO),
	ACCREDITAMENTO_ALLEGATI__DICHIARAZIONE_LEGALE ("accreditamentoAllegati.file.dichiarazioneLegale", 93, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO),
	ACCREDITAMENTO_ALLEGATI__DICHIARAZIONE_ESCLUSIONE ("accreditamentoAllegati.file.dichiarazioneEsclusione", 94, null, SubSetFieldEnum.ALLEGATI_ACCREDITAMENTO),
