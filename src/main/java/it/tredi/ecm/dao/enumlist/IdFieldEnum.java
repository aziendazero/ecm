...
public enum IdFieldEnum {
	...
	COMPONENTE_COMITATO_SCIENTIFICO__IS_COORDINATORE("persona.coordinatore", -1, Ruolo.COMPONENTE_COMITATO_SCIENTIFICO, SubSetFieldEnum.COMPONENTE_COMITATO_SCIENTIFICO, "coordinatore"),
