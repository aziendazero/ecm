...
public interface AccreditamentoRepository extends CrudRepository<Accreditamento, Long> {
	...
	public Accreditamento findOneByProviderIdAndStatoAndDataFineAccreditamentoAfter(Long providerId, AccreditamentoEnum stato, LocalDate data);
	...
	public Set<Accreditamento> findAllByStato(AccreditamentoEnum stato);
}
