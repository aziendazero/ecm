...
public interface AccreditamentoRepository extends CrudRepository<Accreditamento, Long> {
	...
	//QUERY VASCHETTE
		...
		//query e count domande accreditamento a seconda dello stato e del tipo assegnate all'account id
		...
		public Set<Accreditamento> findAllByStatoAndTipoDomandaForAccountId(@Param("stato") AccreditamentoStatoEnum stato, @Param("tipo") AccreditamentoTipoEnum tipo, @Param("id") Long id);
		...
		public int countAllByStatoAndTipoDomandaForAccountId(@Param("stato") AccreditamentoStatoEnum stato, @Param("tipo") AccreditamentoTipoEnum tipo, @Param("id") Long id);

		//query e count domande accreditamento a seconda dello stato assegnate all'account id
		@Query("SELECT v.accreditamento FROM Valutazione v WHERE v.account.id = :id AND v.accreditamento.stato = :stato")
		public Set<Accreditamento> findAllByStatoForAccountId(@Param("stato") AccreditamentoStatoEnum stato, @Param("id") Long id);
		@Query("SELECT COUNT (v.accreditamento) FROM Valutazione v WHERE v.account.id = :id AND v.accreditamento.stato = :stato")
		public int countAllByStatoForAccountId(@Param("stato") AccreditamentoStatoEnum stato, @Param("id") Long id);
	//
	...
	@Query("SELECT v.accreditamento FROM Valutazione v WHERE v.account.id = :id AND v.accreditamento.stato = :stato AND v.accreditamento.tipoDomanda = :tipo")
	public Set<Accreditamento> findAllAccreditamentoByStatoAndTipoDomandaInValutazioneAssignedToAccountId(@Param("stato") AccreditamentoStatoEnum stato, @Param("tipo") AccreditamentoTipoEnum tipo, @Param("id") Long id);

	@Query("SELECT v.accreditamento FROM Valutazione v WHERE v.account.id = :id AND v.accreditamento.stato = :stato")
	public Set<Accreditamento> findAllAccreditamentoByStatoInValutazioneAssignedToAccountId(@Param("stato") AccreditamentoStatoEnum stato, @Param("id") Long id);
	@Query("SELECT COUNT(v.accreditamento) FROM Valutazione v WHERE v.account.id = :id AND v.accreditamento.stato = :stato")
	public int countAllAccreditamentoByStatoInValutazioneAssignedToAccountId(@Param("stato") AccreditamentoStatoEnum stato, @Param("id") Long id);
