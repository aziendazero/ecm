 ...
 * 
 */
@WebFault(name = "WebServiceException", targetNamespace = "http://protocollo.webservice.wr.peng.it/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: it.peng.wr.webservice.protocollo.WebServiceException
     */
